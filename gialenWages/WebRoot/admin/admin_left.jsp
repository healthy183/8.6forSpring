					...
					<dd style='display:block' class='sitem' id='items1_1'>
						<ul class='sitemu'>
							<li id="li1"><s:url action="admin_OperatingMonth_writeMonth.action"
									...
									<s:a href="%{OperatingMonth}"target="main">营运月设置</s:a>
							</li>
							<li id="li1">
								...
								<s:a target="main" href="%{writeStoreMessage}">门店信息设置</s:a>
							</li>	
						</ul>
					</dd>
				</dl>
					...
					<dd style='display:none' class='sitem' id='items2_1'>
						<ul class='sitemu'>
							<li>
										...
										<li>
											<s:url action="admin_arrangeBrand_addBrandGroup.action"
												 namespace="/admin_arrangeBrand" id="addBrandGroup">
													 <s:param name="operatingMonthType" value="{'0'}"></s:param>
													 <s:param name="projectType" value="{'2'}"></s:param>
											</s:url>
											<s:a href="%{addBrandGroup}" target="main">填写组合提成方案</s:a>
										</li>
						</ul>
					</dd>
						...
						<ul class='sitemu'>
							...
							<s:url action="admin_AccountingArea_showLastMonthAreaWages.action"
									namespace="/admin_AccountingArea" id="showLastMonthAreaWages">
									 ...
									 <s:a href="%{showLastMonthAreaWages}" target="main">核算上月门店与区域提成</s:a>
							</li>
						
							<li>
								<c:url value="admin_countProductProject/admin_countProductProject_showCountProductProjectsByAreaNew.action" var="showCountProductProjectsByArea">
							...
							<!-- <li>
										...
										<s:url action="admin_PlanBrandRelation_ShowBrandWages.action"
											...
											<s:a href="%{ShowBrandWages}" target="main">核算品牌提成</s:a>
							</li> -->
							
							
							<li>
										<s:url action="admin_PlanBrandRelation_Show_BrandWages.action"
												 namespace="/admin_PlanBrandRelation" id="Show_BrandWages">
													 <s:param name="operatingMonthType" value="{'0'}"></s:param>
													 <s:param name="projectType" value="{'1'}"></s:param>
											</s:url>
											<s:a href="%{Show_BrandWages}" target="main">显示品牌提成</s:a>
							</li>
							<li>
										<s:url action="admin_PlanBrandRelation_Show_QverQuota.action"
												 namespace="/admin_PlanBrandRelation" id="Show_QverQuota">
													 <s:param name="operatingMonthType" value="{'0'}"></s:param>
													 <s:param name="projectType" value="{'1'}"></s:param>
													  <s:param name="braId" value="{'02001'}"></s:param>
											</s:url>
											<s:a href="%{Show_QverQuota}" target="main">显示超额</s:a>
							</li>
				...
				<dl class='bitem'>
					...
					<dd style='display:none' class='sitem' id='items4_1'>
						...
						<%--<li id="li1">
							...
							<s:a href="%{showLastMonthAreaWages}" target="main">夏季02期门店销售总提成表</s:a>
							</li>
							--%>
							<li>
						<c:url value="admin_showTable/admin_showTable_showUsrWages.action" var="showUsrWages">
									<c:param name="operatingMonthType" value="0"></c:param>
							</c:url>
								<a href="${showUsrWages}" target="main">员工销售提成汇总表(明细)</a>
							</li>
						<li>
						
							<c:url value="admin_showTable/admin_showTable_collectUsrWages.action" var="collectUsrWages">
									<c:param name="operatingMonthType" value="0"></c:param>
							</c:url>
								<a href="${collectUsrWages}" target="main">员工销售提成汇总表(汇总)</a>
							</li>
							
							<li>
							<c:url value="admin_showTable/admin_showTable_showStoreWages.action" var="showStoreWages">
									<c:param name="operatingMonthType" value="0"></c:param>
								</c:url>
								<a href="${showStoreWages}" target="main">员工销售总提表 </a>
							</li>
							
							<li>
							<c:url value="admin_showTable/admin_showTable_showAreaWagesTable.action" var="showAreaWagesTable">
									<c:param name="operatingMonthType" value="0"></c:param>
								</c:url>
								<a href="${showAreaWagesTable}" target="main">区长销售提成汇总表</a>
							</li>
						</ul>
					</dd>
				</dl>
