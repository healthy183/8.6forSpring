...
<title>My JSP 'writeMonth.jsp' starting page</title>
		...
		<table class="myTable" cellpadding="3" cellspacing="1">
			<tr>
				<th class="myTableTh" align="left">
					...
					<b style="font-size:16px;">
					  请上传${requestScope.thisYear}本年营运月安排execl表:
					 </b> 
			...
			<tr class="myTableTr" align="left">
				<td class="myTableTd" align="left">
							<input id="redId" type="text" value="${requestScope.msg}" readonly="readonly"/>
					<span id="span"></span>
				</td>
			</tr>
