...
jq(function(){
	jq("#updtmiddleTable").click(function(){
		...
		//alert("空吗?"+projectTypeVar == "");
		//alert(projectTypeVar);
		...
		//alert("productProjectNameVar:"+productProjectNameVar);
		//alert("productProjectTypeVar:"+productProjectTypeVar);
		//alert("productProjectVal:"+productProjectVal);
		//alert("projectTypeVar:"+projectTypeVar);
...
/*
 ...
 <script type="text/javascript" charset="gb2312" src="js/isReturn.js">
 </script>
  </head>
  ...
  <input type="hidden" name="projectType" value="${param.projectType}"></input>
	...
	<tr class="myTableTh">
		<th colspan="4">
			<b style="font-size:16px;">新增单品项目</b>
			...
			<tr class="titleClass">
   				...
   				营运月:${requestScope.thisoperatingMonth.operatingMonthName}
						...
						<td>
							...
							<input id="projectType" type="hidden" value="0"></input><font style="color: red;">*</font>
						</td>
						<td>
							...
							<input id="productProjectVal" ></input><font style="color: red;"> *</font>
