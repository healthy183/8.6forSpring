...
<html>
  ...
  <body>
  	...
  	<table class="tableA">
  		...
  		<tr class="myTableTh">
			<th colspan="9">
			<b style="font-size:16px;margin-top:30px;">项目信息</b>
		...
		<input type="button" value= "返回 "  onclick= "javascript:history.go(-1) ">
  		...
  		<tr>
   			...
   			<table class="tableA">
   				<tr class="myTableTh">
   					<th colspan="9">
   						<b style="font-size:16px;margin-top:30px;">项目单品明细:</b>
   					</th>
   				</tr>
   				<tr>
   					<th>序号</th><th>商品编号</th><th>商品条码</th><th>商品名称</th><th>规格</th>
					<th>品牌小类</th><th>品类小类</th><th>商品类型</th><th>商品状态</th>
   				</tr>
