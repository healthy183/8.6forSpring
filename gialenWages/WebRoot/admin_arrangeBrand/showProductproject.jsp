	...
	<table class="tableA">
		<tr class="myTableTh">
	        ...
	        <b style="font-size:16px;">
		   	...
		   	<input type="button" id="addProductProjectButton" value="新增单品方案"></input>
		    <input type="button" id="showRepeatProProject" value="删除本营运月项目重复单品安排"></input>
			...
			<tr align="right">
				<td colspan="9">
					<c:if test="${requestScope.totalPages >0}">
						<c:url	value="admin_arrangeBrand/admin_arrangeBrand_addBrand.action" var="firstPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
					...
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_addBrand.action" var="prevPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
					...
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_addBrand.action" var="nextPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
					...
					<c:if test="${requestScope.totalPages >0}">
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_addBrand.action" var="lastPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
