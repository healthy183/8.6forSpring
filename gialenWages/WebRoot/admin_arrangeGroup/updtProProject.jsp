...
<table class="tableA">
		<tr>
			<th align="center">修改单品提成计划填写表</th>
		</tr>
			</table>
			<table  class="tableAbb" >
				...
				<table id="2"  class="tableA">
   				...
   				营运月:${requestScope.productProject.operatingMonth.operatingMonthName}
						...
						<td>
							单品方案名称:<input id="productProjectName" value="${requestScope.productProject.productProjectName}"></input>
						...
						<td>
							...
							<input id="productProjectVal" value="${requestScope.productProject.productProjectVal}"></input>
