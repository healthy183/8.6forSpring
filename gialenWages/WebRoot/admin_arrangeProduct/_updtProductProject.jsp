															...
															.each(
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				+ tdproFlag
																				+ "</td>"
																				+ "<td><input id='QplanBrandType2' size='2' value='0' type='hidden'  readonly='true'/><td><input id='QplanBrandmainPlan2' size='2' value='X' type='hidden'  readonly='true'  /></td> </td>"
																				+ "</tr>";
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				* 1
																				...
																				+ "<td><input id='QproductBrandId1' class='proIdClass3' value='"+v[0]+"' type='hidden'   readonly='true' /> </td>"
																				+ "<td><input type='hidden' id='QplanBrandType1' size='2' value='1'   readonly='true'/> </td><td><input id='QplanBrandmainPlan1' size='2' value='X' readonly='true' type='hidden' /></td>"
																				+ "</tr>";
									...
									.updtProduct_Project(
											...
											function(data) {
												jq("#productProjectId").val(
														data);
												var answer = confirm("修改品牌项目成功!是否返回项目清单页面?");
												if (answer) {
													return false;
												} else {
													return false;
			...
			<td>
				<table id="2" border="1">
					<tr class="titleClass">
						...
						<td>方案名称:<input id="productProjectName" value="${requestScope.productProject.productProjectName}"></input>
							<input id="projectType" type="hidden" value="0"></input>
副任务<input
							id="planBrandsecondPlan" size="5" value="X"></input>
								...
								<c:forEach items="${Product_PlanBrandlist}" var="table"
									...
									<td><input id='QplanBrandsecondPlan1'
										...
										<td><input id='QparentPlanBrandId1'
											value='${table.productBrand.brandName}'  />
										</td>
										...
										<td><input id='QproductBrandId1' class='proIdClass3'
											value='${table.productBrand.id}' readonly='true' type='hidden'/>
										</td>
										<td><input id='QplanBrandType1' size='2' value='1'
								...
								<c:forEach items="${ProId_PlanBrandlist}" var="table"
									...
									<tr>
										...
										<td><input  id='QProId2' class='proIdClass4'
											value='${table.product.proId}' readonly='true'   /></td>
										...
										<td><input id='QplanBrandType2' size='2' value='0'
