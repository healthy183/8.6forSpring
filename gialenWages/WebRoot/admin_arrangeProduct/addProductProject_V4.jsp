															...
															.each(
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				+ "<td><input id='QplanBrandunFinishedPointQuota2' value='"+planBrandunFinishedPointVar+"' size='2'     /> </td>"
																				+ "<td>"
																				+ tdproFlag
																				+ "</td>"
															...
															.each(
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				+ "<td><input id='QplanBrandunFinishedPointQuota1' value='"+planBrandunFinishedPointVar+"' size='2'     /> </td>"
				...
				<table id="2" border="1">
					<tr class="titleClass" colspan="6">
						<td><input id="operatingMonthId" type="hidden"
							...
							id="productProjectName" size='10'></input> 副任务<select id="planBrandsecondPlan">
							...
							id="planBrandtaskType">
								
								<option value="0">无任务</option>
								<option value="1">有任务</option>
						</select> 完成提点<input id="planBrandfinishedPoint" size='10' value="0"></input> 未完成提点<input
							id="planBrandunFinishedPoint" size='10' value="0"></input></td>
					...
					<tr class="titleClass">
						...
						</select> 定额<input id="planBrandfinishedQuota" size='10' value="0"></input> 完成定额提点<input
							id="planBrandfinishedPointQuota" size='10' value="0"></input> 未完成定额提点<input
							id="planBrandunFinishedPointQuota" size='10' value="0"></input>
						</td>
					</tr>
