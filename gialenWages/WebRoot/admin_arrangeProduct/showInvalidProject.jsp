   ...
   <table class="tableA">
   	<tr>
  		...
  		<c:forEach items="${requestScope.thisYearOperatingMonthList}" var="Month">
			...
			<input type="button" id="addBrand"  value="返回"></input><br>
   		</th>
   	</tr>
   		<tr>
   			<td>序号</td><td>方案名称</td>
   	...
   	<tr  class="mybgcolor">
				...
				<td>
					...
					<c:url value="admin_arrangeBrand/admin_arrangeBrand_restoreProProject.action" var="restoreProProject">
					...
					<a onclick="return confirm('您确定要恢复该方案?');" href="${restoreProProject}">恢复</a>
				</td>		
			</tr>
   		</c:forEach>
   				<tr>
				<td colspan="9">
					...
					<c:if test="${requestScope.totalPages >0}">
						<c:url	value="admin_arrangeBrand/admin_arrangeBrand_showInvalidProProject.action" var="firstPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
					...
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_showInvalidProProject.action" var="prevPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
					...
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_showInvalidProProject.action" var="nextPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
					...
					<c:if test="${requestScope.totalPages >0}">
					<c:url	value="admin_arrangeBrand/admin_arrangeBrand_showInvalidProProject.action" var="lastPage">
						<c:param name="operatingMonthType" value="${param.operatingMonthType}"></c:param>
						<c:param name="projectType" value="${param.projectType}"></c:param>
						<c:param name="operatingMonthId" value="${requestScope.thisOperatingMonth.operatingMonthId}"></c:param>
