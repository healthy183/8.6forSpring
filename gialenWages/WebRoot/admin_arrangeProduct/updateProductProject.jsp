															...
															.each(
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				+ "' /></td>"
																				+ "<td><input id='QparentPlanBrandId2' value='"+v[4]+"' size='10'/></td>"
																				...
																				+ "<td><input id='QplanBrandunFinishedPointQuota2' value='0' size='2'  type='hidden'   /> </td>"
																				+ "<td>"
																				+ tdproFlag
																				+ "</td>"
																				+ "<td><input id='QplanBrandType2' value='0' type='hidden'  readonly='true'/> </td>"
																				+ "<td><input id='QplanBrandmainPlan2' size='2' value='X' type='hidden'  readonly='true'  /></td></tr>";
															...
															.each(
																	...
																	function(n,
																		...
																		checkboxString += "<tr  >"
																				...
																				+ "<td><input id='QplanBrandsecondPlan1' size='5' value='"
																				+ ('X' + ((lastIndex1 * 1) + n) * 1)
																				+ "'/></td>"
																				+ "<td><input id='QparentPlanBrandId1' value='"+v[2]+" 'size='10'/></td>"
																				...
																				+ "<td><input id='QplanBrandunFinishedPointQuota1' value='0' size='2' type='hidden'    /> </td>"
																				+ "<td><input id='QplanBrandType1' value='1'  type='hidden' /> </td>"
																				+ "<td><input id='QplanBrandmainPlan1' size='2' value='X' type='hidden'  readonly='true'  /></td></tr>";
	...
	jq(function() {
		jq("#updtmiddleTable")
				.click(
					...
					var planBrandtaskTypVar =jq("#planBrandtaskType").val();
							
							
							// alert("planBrandtaskTypVar :"+planBrandtaskTypVar);
							...
							//alert(productProjectIdVar);
							 ...
							 // alert("operatingMonthIdVar :"+operatingMonthIdVar +"- PlanBrandSql :"+PlanBrandSql);	
							//   alert("PlanBrandSql_brand :"+PlanBrandSql_brand +"- productProjectNameVar :"+productProjectNameVar);	
							  //	 alert("productProjectIdVar :"+productProjectIdVar +"- planBrandtaskTypVar :"+planBrandtaskTypVar);	
							var operatingMonthIdVar = jq("#operatingMonthId")
									.val();
									
								//alert("PlanBrandSql_brand" +PlanBrandSql_brand.length);	
									//alert("PlanBrandSql" +PlanBrandSql.length);
							dwrAddBrand
									.updtProduct_Project(
											operatingMonthIdVar,
											PlanBrandSql,
...
<body>
	...
	<table id="2" class="tableA">
		<tr class="titleClass" colspan="6">
			<td><input id="operatingMonthId" type="hidden"
				...
				id="productProjectName" size='10'
				value="${requestScope.productProject.productProjectName}"></input>
				副任务<select id="planBrandsecondPlan">
			...
			<input type="hidden" id="productProjectId"
				value="${requestScope.productProject.productProjectId}"></input>
			<!-- 当前单品项目id -->

			<td rowspan="2"><input type="button" id="updtmiddleTable"
				class="updtmiddleTable" value="修改" />
			</td>
		</tr>
		...
		<tr class="titleClass">
			...
			<td colspan="6"><select id="planBrandfinishedType">
				...
				<input id="planBrandunFinishedPointQuota" size='10' type="hidden"
				value="0"></input> 超定额<input id="planBrandqverQuota" size='10'
	...
	<table id="proTable" class="tableaaa">
		<tr id="abc">
			<td>序号</td>
		...
		<c:forEach items="${Product_PlanBrandlist}" var="table" varStatus="p">
			<tr>
				<td>X${p.index+1}</td>
	...
	<td><input id='QplanBrandqverQuota1'
					value='${table.planBrandqverQuota}' size='2' />
				</td>


				<td><input id='QplanBrandqverQuotaPoint1'
					value='${table.planBrandqverQuotaPoint}' size='2' />
				</td>

				<td><input id='QplanBrandType1' type='hidden'
					value='${table.planBrandType}' /></td>
					<td><input id='QplanBrandunFinishedPointQuota1'
					value='${table.planBrandunFinishedPointQuota}' size='2' value="0"
					type="hidden" />
				</td>
		</c:forEach>
		...
		<c:forEach items="${ProId_PlanBrandlist}" var="table" varStatus="t">
			<tr>
				<td>Y${t.index+1}</td>
				<td><input type="checkbox" id="mustbeCheck" class="proIdClass2"
					value="${p.index+1}" checked="checked" name="items2">
				</td>
				...
				<td><input id='QplanBrandfinishedPointQuota2'
					...
					<td><input id='QplanBrandqverQuota2'
					value='${table.planBrandqverQuota}' size='2' />
				</td>


				<td><input id='QplanBrandqverQuotaPoint2'
					value='${table.planBrandqverQuotaPoint}' size='2' />
				</td>
