						...
						//	alert(productProjectIdVar);
							...
							dwrAddBrand
									.updtProduct_Project(
											...
											PlanBrandSql,
											PlanBrandSql_brand,
											productProjectNameVar,productProjectIdVar,
											function(data) {
			...
			<td>
				<table id="2" border="1">
					<tr class="titleClass">
						...
						<input type="hidden" id="productProjectId" value="01"></input>
						<td align="right"><input type="button" id="updtmiddleTable"
							class="updtmiddleTable" value="提交" />  </td>
					</tr>
					<tr>
						<td colspan="7">
								...
								<c:forEach items="${Product_PlanBrandlist}" var="table"
									...
									<tr>
										...
										<td><input type="checkbox" id="hjk_"
											value="${p.index+1}" class="proIdClass1"
											checked="checked"  name="items1"/>
										</td>

 
										<td><input id='QplanBrandsecondPlan1'
											value='${table.planBrandsecondPlan}' size='2' /></td> 
										...
										<td><select id="QplanBrandfinishedType1">
												...
												<c:if test="${table.planBrandfinishedType == 1}">
													<option value="1">有定额</option>
												</c:if>
												<c:if test="${table.planBrandfinishedType == 0}">
													<option value="0">无定额</option>
												</c:if>
										...
										<td><input id='QproductBrandId1' class='proIdClass3'
											value='${table.productBrand.id}' readonly='true' />
										</td>
								...
								<c:forEach items="${ProId_PlanBrandlist}" var="table"
									...
									<tr>
										...
										<td><input type="checkbox" id="mustbeCheck"
											class="proIdClass2" value="${p.index+1}"
											checked="checked"  name="items2">
										</td>
										...
										<td><input id='QproductBrandId2' class='proIdClass4'
											value='${table.product.proId}' readonly='true' size='4' /></td>
