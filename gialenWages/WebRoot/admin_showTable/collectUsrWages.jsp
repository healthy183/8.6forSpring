...
<html>
  <head>
    ...
    <title>My JSP 'collectUsrWages.jsp' starting page</title>
  ...
  <body>
    	<c:choose>
  		...
  		<b style="font-size:16px;">
					${requestScope.thisOperatingMonth.operatingMonthName}(${requestScope.startEndDate})员工销售提成汇总表(汇总)
				</b>
  			<div style="text-align: right;float:right;margin-top:-15px; ">
  				<c:url value="admin_showTable/admin_showTable_outCollectUsrWages.action" var="outCollectUsrWages">
  				...
  				<a href="${outCollectUsrWages}" style="float:right;text-decoration:none;">导出execl表</a>
  			</div>
  		</th>
  	</tr>	
    	...
    	<c:forEach items="${sessionScope.collectVoList}" var="vo" varStatus="v">
    		<tr class="mybgcolor">
