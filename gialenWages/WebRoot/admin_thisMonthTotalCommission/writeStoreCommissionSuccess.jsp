...
<html>
  <head>
    ...
    <title>My JSP 'writeStoreCommissionSuccess.jsp' starting page</title>
  ...
  <body onload="loadPage();">
   <script type="text/javascript">
   		...
   		function countDown(){
   			...
   			location.href= "admin_thisMonthTotalCommission_writeStoreCommission?operatingMonthType="+
   				"${param.operatingMonthType}&operatingMonthPathMoneyType="+
   					"${param.operatingMonthPathMoneyType}&operatingMonthId="+"${param.operatingMonthId}";
   			}
   		} 
   </script>
     <s:url action="admin_thisMonthTotalCommission_writeStoreCommission.action" 
   		  namespace="/admin_thisMonthTotalCommission" id="writeAreaWages">
  	 ...
  	 本营运月门店总提标准表上传成功!
   <font id="num" size="5" >5</font>秒后自动跳会<s:a href="%{writeAreaWages}">返回</s:a>查看！
