...
<html>
  <head>
    ...
    <title>My JSP 'showAreaWages.jsp' starting page</title>
...
<script type='text/javascript' src='/gialenWages/dwr/util.js'></script>
 ...
 <script language="javascript" charset="gb2312" 
 		type="text/javascript" ><%--src="js/validateAreaWages.js" --%>
 		...
 		jq(function(){
 			...
 			jq("#button").click(function() {
				...
				dwrShowError.uploadExecl(realpath,function(fileString){
 					...
 					dwrShowError.showAreaError(fileString,test);	
 				});
 			});
 ...
 <script type="text/javascript">
 	...
 	jq(function(){
 		jq("#operatingMonthId").change(function(){
 			location.href
				= "admin_thisMonthWages_writeAreaWages.action?operatingMonthType="+
  ...
  <body>
   ...
   <s:form action="admin_thisMonthWages_writeAreaWagesSuccess.action" namespace="/admin_thisMonthWages"
    	...
    	<table class="myTable" cellpadding="3" cellspacing="1">
    		<tr>
			  ...
			  <b style="font-size:16px;"> 
			   如需修改<select name="operatingMonthId" id="operatingMonthId">
						<option
			 ...
			 区域销售奖核算标准,请上传execl表:
					...
					<input type="submit" value="确认提交"></input><!-- id="button" -->
					</th>
    			</tr>
