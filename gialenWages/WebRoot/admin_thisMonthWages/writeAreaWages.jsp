...
<html>
  <head>
    ...
    <title>My JSP 'writeAreaWages.jsp' starting page</title>
...
<script type='text/javascript' src='/gialenWages/dwr/util.js'></script>
 <script language="javascript" charset="gb2312" 
  ...
  <body>
    ...
    <s:form action="admin_thisMonthWages_writeAreaWagesSuccess.action" 
    	namespace="/admin_thisMonthWages" enctype="multipart/form-data"
    		 method="post" id="upLoadForm" theme="simple">
    		
    		<table class="myTable" cellpadding="3" cellspacing="1">
    			<tr>
					<th class="myTableTh" align="left">
					<s:hidden name="operatingMonthPathMoneyType"
								value="%{#parameters.operatingMonthPathMoneyType}"></s:hidden>
