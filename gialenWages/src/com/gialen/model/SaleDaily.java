...
public class SaleDaily  implements java.io.Serializable {


    // Fields    

     private SaleDailyYymmId id;
     private Employee employee_s;
     private ProductClass productClass_s;
     private ProductBrand productBrand_s;
     private String hqid;
	...
	/** minimal constructor */
    public SaleDaily(SaleDailyYymmId id, ProductClass productClass_s, ProductBrand productBrand_s, String hqid, String barcode) {
        this.id = id;
    ...
    /** full constructor */
    public SaleDaily(SaleDailyYymmId id, Employee employee_s, ProductClass productClass_s, ProductBrand productBrand_s, String hqid, String barcode, String donateType, String transType, String productPmtPlanNo, String brandPmtPlanNo, String transPmtPlanNo, String productType, Double saleTax, String posNo, String salerId, Double saleQty, Double saleAmt, Double saleDisAmt, Double transDisAmt, Double normalPrice, Double curPrice, Double lastCostPrice, String memCardNo, String invoiceId, Double points1, Double points, Double returnRat, String sendflag, String classPmtPlanNo, String brandClassPmtPlanNo, String productClusterPmtPlanNo, Double pcashPayAmt, Double integralPayAmt) {
        this.id = id;
        this.employee_s = employee_s;
        this.productClass_s = productClass_s;
        this.productBrand_s = productBrand_s;
        this.hqid = hqid;
        this.barcode = barcode;
...
//    }
	...
	public Employee getEmployee_s() {
		return employee_s;
	}

	public void setEmployee_s(Employee employee_s) {
		this.employee_s = employee_s;
	}
