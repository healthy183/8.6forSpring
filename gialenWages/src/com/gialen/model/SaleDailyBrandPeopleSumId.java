...
/**
 * SaleDailyBrandPeopleSumId entity. @author MyEclipse Persistence Tools
 */

public class SaleDailyBrandPeopleSumId implements java.io.Serializable {
	...
	/** default constructor */
	public SaleDailyBrandPeopleSumId() {
	}

	/** full constructor */
	public SaleDailyBrandPeopleSumId(Employee employee,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SaleDailyBrandPeopleSumId))
			return false;
		SaleDailyBrandPeopleSumId castOther = (SaleDailyBrandPeopleSumId) other;
