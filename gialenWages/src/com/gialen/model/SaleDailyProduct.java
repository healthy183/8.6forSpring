...
/**
 * SaleDailyProduct entity. @author MyEclipse Persistence Tools
 */

public class SaleDailyProduct implements java.io.Serializable {

	// Fields

	private SaleDailyProductId id;
	...
	/** default constructor */
	public SaleDailyProduct() {
	}

	/** minimal constructor */
	public SaleDailyProduct(SaleDailyProductId id, ProductClass productClass,
			ProductBrand productBrand, String hqid, String barcode) {
		this.id = id;
	...
	/** full constructor */
	public SaleDailyProduct(SaleDailyProductId id, Employee employee,
			ProductClass productClass, ProductBrand productBrand, String hqid,
			String barcode, String donateType, String transType,
			String productPmtPlanNo, String brandPmtPlanNo,
			String transPmtPlanNo, String productType, Double saleTax,
			String posNo, String salerId, Double saleQty, Double saleAmt,
			Double saleDisAmt, Double transDisAmt, Double normalPrice,
			Double curPrice, Double lastCostPrice, String memCardNo,
			String invoiceId, Double points1, Double points, Double returnRat,
			String sendflag, String classPmtPlanNo, String brandClassPmtPlanNo,
			String productClusterPmtPlanNo, Double pcashPayAmt,
			Double integralPayAmt) {
		this.id = id;
	...
	public SaleDailyProductId getId() {
		return this.id;
	}

	public void setId(SaleDailyProductId id) {
		this.id = id;
	}
