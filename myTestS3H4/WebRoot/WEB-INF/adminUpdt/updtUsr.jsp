...
<html>
  <head>
    ...
    <title>My JSP 'updtUsr.jsp' starting page</title>
...
<script type="text/javascript" charset="gb2312">
	$(function(){
		$(".submitUpdt").click(function(){
			var idVar =	$(this).attr("id");
			var usridVar = $("#usrid"+idVar).val();
			var usrnameVar = $("#usrname"+idVar).val();
			var leadIdVar = $("#leadId"+idVar).val();
			
			$.post("${pageContext.request.contextPath}/adminUpdt/updtUsrSuccess.html",
				{usrid : usridVar,usrname : usrnameVar,leadId :leadIdVar},
					function(data){
						alert(data);
					});
		});
