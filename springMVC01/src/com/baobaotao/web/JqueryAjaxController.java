...
public class JqueryAjaxController {
	...
	public @ResponseBody Integer add(
		...
		// 但是你必须添加jackson的jar包  jackson-all.jar!!!
		return sum;
	}	
	...
	public @ResponseBody JqueryAjaxJsonUser getUser(@PathVariable("userId")String  userId) {
		...
		users.put("1", new JqueryAjaxJsonUser("123456", "李逵", "123", "成都市", "1", 23));
		users.put("2", new JqueryAjaxJsonUser("565676", "张三", "123", "北京市", "2", 53));
		users.put("3", new JqueryAjaxJsonUser("325566", "李四", "123", "河南省", "2", 93));
		users.put("4", new JqueryAjaxJsonUser("989654", "刘邦", "123", "蒙古包", "1", 13));
		users.put("5", new JqueryAjaxJsonUser("234444", "王熙凤", "123", "成都市", "1", 43));		
	...
	List<JqueryAjaxJsonUser> getUsers() {		
		...
		users.add(new JqueryAjaxJsonUser("123456", "李逵", "123", "成都市", "1", 23));
		users.add(new JqueryAjaxJsonUser("123457", "李四", "124", "北京市", "2", 53));
		users.add(new JqueryAjaxJsonUser("123458", "李三", "125", "河南市", "0", 73));
		users.add(new JqueryAjaxJsonUser("123459", "李五", "126", "大路市", "3", 93));
		return users;
	}
	...
	public @ResponseBody Map<String,JqueryAjaxJsonUser> getUserMap() {		
		Map<String,JqueryAjaxJsonUser> users = new HashMap<String,JqueryAjaxJsonUser>();
		users.put("1", new JqueryAjaxJsonUser("123456", "李逵", "123", "成都市", "1", 23));
		users.put("2",new JqueryAjaxJsonUser("123457", "李四", "124", "北京市", "2", 53));
		users.put("3",new JqueryAjaxJsonUser("123458", "李三", "125", "河南市", "0", 73));
		users.put("4",new JqueryAjaxJsonUser("123459", "李五", "126", "大路市", "3", 93));
		return users;
	}
}
